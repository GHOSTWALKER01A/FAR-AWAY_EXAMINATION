...
export default function ProctoringCenter() {
  ...
  return (
    <div>
      <PageHeader
        title="Proctoring command center"
        subtitle="All live exams. Enter any to watch candidates in real time."
      />
      {isLoading ? (
        <LoadingBlock />
      ) : !data || data.length === 0 ? (
        <EmptyState
          title="No live exams"
          message="When an exam goes live, it appears here for monitoring."
        />
      ) : (
